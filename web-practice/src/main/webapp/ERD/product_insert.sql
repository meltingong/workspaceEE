...
--product insert
--반지
insert into product values(product_p_no_SEQ.nextval,'하트 태그링',930000,'전설적인 하트 태그로 잘 알려진 아이코닉한 리턴 투 티파니™ 컬렉션은 1969년에 첫선을 보인 티파니의 키 링에서 영감을 받아 탄생했습니다.','ring1.jpeg','로즈골드',1);
insert into product values(product_p_no_SEQ.nextval,'라운드 브릴리언트 웨딩 링',70000000,'가사와 음악이 자연스럽게 하나가 되는 것처럼 티파니 하모니® 웨딩 링은 웨딩 밴드와 완벽한 조화를 이룹니다.','ring2.jpeg','화이트골드',1);
insert into product values(product_p_no_SEQ.nextval,'하모니 웨딩 링',56000000,'가사와 음악이 자연스럽게 하나가 되는 것처럼 티파니 하모니® 웨딩 링은 웨딩 밴드와 완벽한 조화를 이룹니다.','ring3.jpeg','화이트골드',1);
...
insert into product values(product_p_no_SEQ.nextval,'오픈 하트 펜던트',930000,'심플하면서도 아름다운 디자인의 엘사 퍼레티™ 오픈 하트는 사랑의 정신을 기념합니다. ','necklaces4.png','로즈골드',2);
